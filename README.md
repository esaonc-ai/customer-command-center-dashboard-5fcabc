...
## Current Dashboard State (Last Refresh: Sep 6 21:00 ET – AUTHORITATIVE v21)
...
| UFN-Count | 287 |
| Excluded | 65 — 38 Reopen display-name (outside New/Pending gate) + 22 billing/UF Billing/storage/handling/claims + 5 duplicate threads (same 5 pairs as v20: kept 69946 dropped 69943 / kept 69942 dropped 69941 / kept 69896 dropped 69893 / kept 69892 dropped 69889 / kept 69663 dropped 69661) |
...
| Outlook Coverage | Partial this cycle (shared mailbox 403 ErrorAccessDenied; delegated inbox scanned 20:33→21:00 ET, **0 new hits**) — **10** eligible-ticket threads carried forward (~3.5%); strongest signals Diageo/Ritual claim 18050 (UFN-69811), Boundless Walmart load-45872185 (UFN-69618/UFN-69771/UFN-69942) |
| Last Refresh | 2026-09-06 21:00 ET (**AUTHORITATIVE** – fresh TicketOps LIVE pull; 352 open UFN = 241 New/73 Pending/38 Reopen; **population identical to v20** 20:33 ET — 0 arrivals/removals/status changes; eligible **287 unchanged** = 218 New/69 Pending (0 net); closeFlag still NOT a gate (19 retained); UFN-67030 remains Solved/system-20, closed 09/01 → outside gate) |
...
### ⏱ Queue Delta (this refresh: v20 → v21)

**AUTHORITATIVE v21 pull (2026-09-06 ~21:00 ET / 01:00Z 09-07)** — fresh TicketOps LIVE enumeration (dept 323826714354839552, `POST /v1/iam/tickets/page`, `input{departmentIds:[323826714354839552], displayStatusSystemStatus:[10]}`, UFN prefix client-side; server status-statistics cross-checked via `POST /v1/iam/report/ticket/status`): **352 open UFN** (241 New / 73 Pending / 38 Reopen). **+0 total since v20 (20:33 ET)** — population & display-status distribution IDENTICAL to v20; no tickets opened, closed, or changed status in the ~27-min window; all 287 v20 eligible rows remain open and eligible (0 eligible→Reopen, 0 removals, 0 new arrivals). Eligibility gate unchanged: `displayStatusSystemStatus=open` + `displayStatusName ∈ {New,Pending}`; `closeFlag` is **NOT** a filter → **19 live `closeFlag=true` tickets retained** (UFN-68733/UFN-68750 auto-close artifacts; UFN-59720, UFN-69797 Diageo Picks, UFN-69618 Boundless no-labels, UFN-43887 Ritual stickering). After the same audit exclusions — **38 Reopen** (display name; identical to v20), **22 billing/UF Billing/storage/handling/claims invoice items** (v20 audit ids re-verified present; operational keepers retained: UFN-60009 BOL, UFN-68749 storage-SQFT data request, UFN-69818 open-RN ops digest, UFN-69231/UFN-63762/UFN-63959 invoice-dispute ops, UFN-69811 Diageo claim 18050, Boundless incident UFN-69771/UFN-69618/UFN-69942) and **5 duplicate ticket/email threads** (same 5 pairs as v20: kept 69946 dropped 69943 / kept 69942 dropped 69941 / kept 69896 dropped 69893 / kept 69892 dropped 69889 / kept 69663 dropped 69661 — regenerated twin emails) — **287 eligible = 218 New / 69 Pending** (identical set to v20; net 0). Per-row ages recomputed exactly from live UTC createTime → ET, anchored 21:00:41 ET (delta vs v20 +27m09s; +1h on 111 rows; 3 rows ticked +1 age-day; oldest UFN-33604 exact 4451h / 185d). SLA 200 breached / 87 on track (0 flips); unassigned 231; oldest 185d; customers 53 (ticket-visible coverage; roster supplemental; no org added/removed — DAYDREAM NUTRITION INC. oldestBreachedAgeDays 23→24 only per-customer change; tier split unchanged 36 Critical / 6 Warning / 11 Healthy); buckets Immediate 17 / Short-Term 56 / Medium-Term 37 / Watch 177 (unchanged). **UFN-67030** verified absent from the open set (remains Solved/system-20, closed 09/01) → outside gate. **Outlook**: delegated mailbox accessible via Graph, shared mailbox nht.cs@unisco.com still 403 ErrorAccessDenied; window 09-06 20:33 ET → 21:00 ET: **0 new UFN/Cesanek hits** — 10 eligible-ticket threads carried forward unchanged (3.5% of 287); 2 eligible escalations persist (UFN-69811 Diageo/Ritual claim 18050; Boundless Walmart load-45872185 as one incident). Watermark advanced to 2026-09-07T01:00:41Z (21:00 ET).
