#!/usr/bin/env node
/**
 * NHT/Cesanek Customer Command Center refresh v47.
 *
...
const RAW_FILE = 'scripts/gate-live-2026-09-19-v47.tsv';
const REOPEN_FILE = 'scripts/reopen-live-2026-09-19-v47.tsv';
const REFRESH_INSTANT = new Date('2026-09-19T18:26:00Z');
...
if (!previousConfig.snapshotMetrics.refreshId.endsWith('-AUTHORITATIVE-v46')) fail(`expected v46 predecessor, got ${previousConfig.snapshotMetrics.refreshId}`);
...
readme = readme.replace(/### v45 -> v46 \(/, '### v45 -> v46 (superseded by v47) (');
if (/### v46 -> v47[\s\S]*?(?=### |$)/.test(readme)) readme = readme.replace(/### v45 -> v46[\s\S]*?(?=### |$)/, reconciliationNote);
